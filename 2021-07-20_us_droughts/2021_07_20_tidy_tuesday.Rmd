...
drought_plot %>% 
  ...
  labs(
    ...
    subtitle = "This chart shows the percent of land under drought in the different states of the US since the start of the decade.<br>Wouldn't we all love to live in the <span style='color:steelblue;'>**Cool Eastern States?**</span>",
    fill = "Drought\nLevel",
