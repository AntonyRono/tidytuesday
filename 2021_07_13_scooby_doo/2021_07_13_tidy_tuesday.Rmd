...
activity_visual <- activity %>% 
  ...
  mutate(character = fct_reorder(character, n, max)) %>% 
...
activity_visual %>% 
  ...
  theme(
    ...
    axis.text.y = element_markdown(color = "black", size = 11, vjust = 0),
    ...
    plot.title = element_markdown(size = 25, family = "Franklin Gothic Demi", hjust = .5)
  ...
  labs(x = "", y = "", title = "Scooby-Doo Characters Activity - <span style='color:#B2BE34;'>**Oh Shaggy!**</span>",
